...
public class OutlinedTextBlock : FrameworkElement
{
    ...
    public bool StrokeOutside
    {
        get => (bool)GetValue(StrokeOutSideProperty);
        set => SetValue(StrokeOutSideProperty, value);
    }

    public static readonly DependencyProperty StrokeOutSideProperty = DependencyProperty.Register(
        "StrokeOutSide",
            typeof(bool),
    ...
    protected override Size MeasureOverride(Size availableSize)
    {
        ...
        ArgumentNullException.ThrowIfNull(_formattedText);
