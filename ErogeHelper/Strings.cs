...
{
    public const string App_StartNoParameter = "Can't open ErogeHelper directly ";
    public const string App_StartInvalidPath = "Invalid game path ";
    public const string App_Timeout = "Timeout! Game window not found.";
    public const string App_LENotSetup = "Locate Emulator not found, please set LEProc path in Preference.";
