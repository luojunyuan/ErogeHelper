...
public partial class DevicePage : IEnableLogger, ITouchMenuPage
{
    ...
    private void BackOnClickEvent(object sender, EventArgs e) => _pageSubject.OnNext(TouchMenuPageTag.DeviceBack);
    ...
    private const int ScreenShotHideButtonTime = 3000;
    private async void ScreenShotOnClickEvent(object sender, EventArgs e)
    {
        ...
        await Task.Delay(ScreenShotHideButtonTime).ConfigureAwait(true);
