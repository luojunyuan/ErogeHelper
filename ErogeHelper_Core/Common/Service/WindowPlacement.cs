...
namespace ErogeHelper_Core.Common.Service
{
    ...
    class WindowPlacement
    {
        ...
        /// </summary>
        public static readonly DependencyProperty SaveProperty = DependencyProperty.RegisterAttached("Save", typeof(bool), typeof(WindowPlacement), new FrameworkPropertyMetadata(OnSaveInvalidated));
        ...
        public WindowPlacement(Window pWindow) { mWindow = pWindow; }
        ...
        public WindowApplicationSettings Settings
        {
            get
            {
                if (mWindowApplicationSettings == null)
                    mWindowApplicationSettings = CreateWindowApplicationSettingsInstance();
        ...
        private static void OnSaveInvalidated(DependencyObject pDependencyObject, DependencyPropertyChangedEventArgs pDependencyPropertyChangedEventArgs)
        {
            ...
            if (window != null)
                ...
                {
                    var settings = new WindowPlacement(window);
                    settings.Attach();
                }
        }
        ...
        public class WindowApplicationSettings : ApplicationSettingsBase
        {
            ...
            public WindowApplicationSettings(WindowPlacement pWindowSettings) { }
